    ...
    <div class="row all-center">
      ...
      <div class="col-2 col-md-12">
        <a href="/app/tracks" class="nav-element py-4 px-2">
          ...
          <div class="pt-2 d-none d-md-block font-sm card-md">Tracks&nbsp;<span style=" padding:5px; font-family: Gilroy-Medium; font-size: 12px; line-height: 10px; color: #FFFFFF;background: linear-gradient(90deg, #E74E4B 14.25%, #FB8133 96.93%); border-radius: 25px;">New</span></div>
        </a>
      </div>
      <div class="col-2 col-md-12">
