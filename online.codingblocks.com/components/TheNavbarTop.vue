<template>
  <div>
    <div class="row c-topnav py-4 justify-content-between align-items-center">
      <div class="col-6 px-0 d-md-none d-flex align-items-center pl-3">
        ...
        <img
          src="https://minio.codingblocks.com/motley/online-logo-text.png"
          alt=""
          class="d-inline-block w-70"
        />
      </div>
      <div class="col-4 offset-1 d-md-block d-none">
        <ul>
      ...
      <div class="align-items-center">
        <ul class="right-nav d-md-flex d-none">
          <li
            class="top-nav-option px-3 v-align-ma"
            v-show="walletAmount !== null"
          >
            <a :href="dukaanPublicUrl">
              <img
                class="s-20x20"
                src="https://minio.codingblocks.com/img/wallet-outline.svg"
                alt=""
              />
          ...
          <li class="top-nav-option px-3">
            ...
            >
              <img
                src="https://cb-thumbnails.s3.ap-south-1.amazonaws.com/notification.svg"
              />
            </a>
            <NotificationPopUp
              v-if="!notificationCollapsed"
              data-no-clickaway="true"
            />
          </li>
          <li class="top-nav-option px-3">
            <a
              ...
              v-on-clickaway="closeShoppingCart"
            >
              <img
                src="https://cb-thumbnails.s3.ap-south-1.amazonaws.com/cart.svg"
              />
            </a>
            <ShoppingCartPopUp
              v-if="!shoppingCartCollapsed"
              data-no-clickaway="true"
            />
          </li>
          <li class="top-nav-option hoverable px-3">
            <div
              class="img-desc align-items-center font-sm"
    ...
    <!-- Hamburger -->
    <div
      class="hamburger-nav b-right overflow-y-auto no-scrollbar"
      :class="hamburgerCollapsed && 'hamburger-nav--hidden'"
    >
      <div
        class="d-flex py-3 justify-content-between align-items-center hamburger-nav__top-bar"
      >
        <img
          src="https://minio.codingblocks.com/motley/online-logo-text.png"
          alt="Online CodingBlocks"
      ...
      <div class="d-flex justify-content-center mt-4">
        <nuxt-link
          to="/logout"
          class="button-solid button-orange px-5"
          v-if="user"
        >
          Logout
        </nuxt-link>
      ...
      <div class="mt-5 px-4 overflow-y-auto no-scrollbar">
        ...
        <div class="my-4 pl-4">
          <div
            class="hamburger-nav__menu-element"
            :class="{ active: mobileSelectedTab === 'classroom' }"
            @click="mobileSelectedTab = 'classroom'"
          >
        ...
        <div class="my-4 pl-4">
          <div
            class="hamburger-nav__menu-element"
            :class="{ active: mobileSelectedTab === 'online' }"
            @click="mobileSelectedTab = 'online'"
          >
...
export default {
  ...
  async created() {
    const {
      data: { wallet_amount }
    } = await this.$axios.get('/users/me/wallet')
  ...
  computed: {
    ...
    logoutUrl() {
      return `https://account.codingblocks.com/logout?redirect=${
        config[process.env.NODE_ENV].publicUrl
      }/logout`
    },
    dukaanPublicUrl() {
