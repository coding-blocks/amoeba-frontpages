<template>
  <div>
    ...
    <div class="border-card white ">
      ...
      <RatingStars class="my-4 d-flex align-items-center justify-content-between justify-content-md-start position-relative" 
        :value="+course.rating"
        pos-rating-class="mr-2"
        neg-rating-class="mr-2"
        >
        <span class="ml-md-3 mr-5">
      ...
      <div class="row course-info-row">
        <div class="col-md-5 my-3 my-md-auto">
            <div class="card-mentor-image mr-4 w-20">
