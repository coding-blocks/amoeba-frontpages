<template>
  <div class="row no-gutters justify-content-between">
    <div class="col-12 font-md bold">Student Feedback </div>
    <div class="col-sm-4 col-12 my-auto">
      ...
      <div class="font-sm bold">{{stats.count}} Ratings</div>
    </div>

    <div class="col-sm-8 col-12">
      <div class="row align-items-center mb-2" v-for="stat in distributedStats" :key="stat.stars">
        <div class="col-12 col-sm-7">
          <progress class="progress-yellow" :value="stat.ratio"></progress>
        </div>
        <RatingStars class="col-12 col-sm-5 mt-sm-0 mt-2 rating d-flex"  :neg-rating-class="'d-none'" pos-rating-class="mx-2" :value="+stat.stars">
        </RatingStars>
      </div>
    </div>
  </div>
